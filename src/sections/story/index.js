      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-8" data-aos="fade-up">
            ...
            <h2 className="main-title white">The Trolls in Bikinis</h2>
            <p className="welcome-para">
              The troll is one of the most fascinating animals on Earth and
            ...
            <p className="welcome-para">
              ...
              Very few trolls are left on the planet due to hunting by humans,
              climate change and habitat destruction. Due to these reasons, the
              population of trolls is decreasing day by day.
            </p>
            <p className="welcome-para">
            ...
            <p className="welcome-para">
              ...
              Troll NFT artwork, a certain amount will go towards animal
              welfare.
            </p>
            <p className="welcome-para mb-0">
              Each and every troll is unique and is created in an established
